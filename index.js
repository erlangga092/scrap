...
const switchNum = (num) => {
  if (num.indexOf("081") !== -1) {
    ...
    return true;
  } else if (num.indexOf("81") !== -1) {
    return true;
  } else if (num.indexOf("82") !== -1) {
    return true;
  } else if (num.indexOf("83") !== -1) {
    return true;
  } else if (num.indexOf("85") !== -1) {
    return true;
  } else if (num.indexOf("87") !== -1) {
    return true;
  } else if (num.indexOf("88") !== -1) {
    return true;
  } else if (num.indexOf("89") !== -1) {
    return true;
...
eksekusiPromise(138_001, 140_000, "masjid-4", "update");
